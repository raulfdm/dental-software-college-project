 ...
 */
public class FormatoMoedaReal extends JTextField {
    ...
    public FormatoMoedaReal(int casasDecimais) {
        this(new DecimalFormat((casasDecimais == 0 ? "#,##0" : "#,##0.") + makeZeros(casasDecimais)));
    }

    public FormatoMoedaReal() {
        this(MONETARY_FORMAT);
    }

    public FormatoMoedaReal(NumberFormat format) {// define o formato do 
        // número 
        ...
        setDocument(new PlainDocument() {
            ...
            public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
                String text = new StringBuilder(FormatoMoedaReal.this.getText().replaceAll("[^0-9]", "")).append(str.replaceAll("[^0-9]", "")).toString();
